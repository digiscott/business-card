...
export function LearnMoreLinks({ profile }: Props) {
  return (
    <section id="learn-more" className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
      <div className="rounded-[2rem] bg-ink p-8 text-white shadow-soft dark:bg-white dark:text-ink">
        <p className="text-sm font-black uppercase tracking-wider text-cyan-200 dark:text-accent">Learn more</p>
        <h2 className="mt-3 text-4xl font-black">Use the right follow-up path for the conversation.</h2>
